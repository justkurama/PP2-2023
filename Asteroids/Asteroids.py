...
icon = pygame.image.load('Asteroids/asteroidsPics/asteroid100.png')
pygame.display.set_icon(icon)

bg = pygame.image.load('Asteroids/asteroidsPics/starbg.png')
alienImg = pygame.image.load('Asteroids/asteroidsPics/alienShip.png')
playerRocket = pygame.image.load('Asteroids/asteroidsPics/spaceRocket.png')
star = pygame.image.load('Asteroids/asteroidsPics/star.png')
asteroid50 = pygame.image.load('Asteroids/asteroidsPics/asteroid50.png')
asteroid100 = pygame.image.load('Asteroids/asteroidsPics/asteroid100.png')
asteroid150 = pygame.image.load('Asteroids/asteroidsPics/asteroid150.png')

shoot = pygame.mixer.Sound('Asteroids/sounds/shoot.wav')
bangLargeSound = pygame.mixer.Sound('Asteroids/sounds/bangLarge.wav')
bangSmallSound = pygame.mixer.Sound('Asteroids/sounds/bangSmall.wav')
shoot.set_volume(.25) 
...
class Player(object):
    def __init__(self):
        ...
        self.head = (self.x + self.cosin * self.w//2, self.y - self.sin * self.h//2)
